...
If you built the image locally and don't have access to a container registry, export and copy it directly:
...
**1. Get the application image**

```bash
podman pull ghcr.io/svenjacobs/pearls:latest
```

Or build locally (see [Building the image locally](#building-the-image-locally)).
